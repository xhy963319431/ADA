...
flags.DEFINE_enum('dataset', 'ml1m', ['ml1m', 'nf'], 'Dataset.')
...
flags.DEFINE_float('l2_regularization',0.0001,'L2 reaulariaztion coefficient.')
flags.DEFINE_enum('dataset_type', 'AVE', ['ONLY_5','AVE', 'T_CE', 'RAN','AVE_T_CE'], 'Select dataset type.')
